...
def populated_source_db(source_db_connection: sqlite3.Connection) -> sqlite3.Connection:
    ...
    test_movies = [
        (
            ...
            2000,
            8.5,
            '{"detail": {"rating": {"count": 1000}, "pic": {"normal": "http://example.com/p1.jpg"}, "card_subtitle": "2000 / 剧情 犯罪"}}',
            "movie",
        ),
        (
            "1002",
        ...
        (
            ...
            2015,
            None,
            '{"detail": {"card_subtitle": "2015 / 科幻"}}',
            "movie",
        ),
        ("1005", "tt1005", "Test Movie No Genres", 2020, 6.0, "{}", "movie"),
    ]
